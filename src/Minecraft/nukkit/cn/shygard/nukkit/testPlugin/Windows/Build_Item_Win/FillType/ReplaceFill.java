package Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType;
...
public class ReplaceFill extends FormWindowCustom {
    public ReplaceFill(List<Element> elements) {
    ...
    public static FormWindowCustom Replace_Fill(){
        ...
        el.add(new ElementLabel("§l§6输入方块特殊值"));
        el.add(new ElementInput(" "));
        el.add(new ElementLabel("输入代替方块§l§6    输入方块ID"));
        el.add(new ElementInput(" "));
        el.add(new ElementLabel("§l§6输入方块特殊值"));
        el.add(new ElementInput(" "));
