...
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Blocks.*;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Entity.Anchor;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Entity.BaseNpc;
...
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Tool.ball_tool.ball;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Tool.round_tool.round;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.Build_Menu.getBuildWindow;
    ...
    public void onLoad() {
        ...
        if (Item.fromString("np:world_menu").equals(Item.get(0))) {
            ...
            if (online_list.size() > 0) {
                Set<UUID> keySet = online_list.keySet();
