...
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Tool.WoodAxe;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.Build_Menu;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.CommonFill;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.KeepFill;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.RandomFill;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.ReplaceFill;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.*;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.*;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Personal.Personal_System;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.*;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Setting.Setting;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Shop.Shop;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Socail.Social_Contact;
import Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Teleport.Teleport_Menu;
...
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Main_PluginBase.*;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.CommonFill.common_fill;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.CommonFill.common_fill_do;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.KeepFill.KeepFill_do;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.KeepFill.Keep_Fill;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.RandomFill.Random_Filll;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.ReplaceFill.ReplaceFill_do;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.ReplaceFill.Replace_Fill;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Build_Item_Win.FillType.UndoFill.undo_Fill;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Menu.getNpc_Menu;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting.getNpc_Setting;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Base.getNpc_Setting_Base;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Base_Delete.Npc_Delete;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Base_Equipment.Change_Npc_Equipment;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Base_Equipment.Clone_Equipment;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Base_Model.Change_Npc_Model;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Base_Model.Npc_Model;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Base_Name.Change_Npc_Name;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Base_Name.Npc_Name;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Skin.ChangeSkinSuccess;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_Setting_Skin.getNpc_Setting_Skin;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.Npc_information.getNpc_information;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Create_NPC.SpawnNpc.Spawn_Npc;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.CreateHome.CreateWorld;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.CreateHome.getWindowCreateHome;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.Home.OpHomeMenu;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.HomeList.Home_List;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.HomeOpMenu.getWindowHomeOpMenu;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.Managing_Do.Managing;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.Managing_Homes.Managing_List;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Home.MyHome.MyHomeTest;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Personal.Personal_System.getWindowPersonal_System;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.CreateFile.Super_File;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.CreateFile.Window_Crate_Files;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.Create_To.Create_Yml_To;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.FileList.Window_File_List;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.Filecenter.Crate_Files;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.Introduct.getIntroduction;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.Paste_Build.*;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.SaveBuild.Create_Yml;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.Save_Success.SaveSuccess;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.SaveBuilder.opSaveBuilder.getWindow_op_save_builder;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Setting.Setting.getWindowSetting;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Shop.Shop.getWindowShop;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Socail.Social_Contact.getWindowSocial_Contact;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.Teleport.Teleport_Menu.getWindowTeleport_Menu;
import static Minecraft.nukkit.cn.shygard.nukkit.testPlugin.Windows.WorldMenuWindow.getWindowSimple;
...
//坐骑前后按键判定（赛车）
        if(event.getPacket().offset == 11){
            if(event.getPlayer().riding != null && event.getPlayer().riding.getName().equals("np:car1")){
                ...
                car1.mx = Double.parseDouble(x.toString());
                car1.my = Double.parseDouble(y.toString());
            }
        }
    }
    @EventHandler
