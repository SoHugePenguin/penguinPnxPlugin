...
import static Minecraft.nukkit.cn.sohugepenguin.plugin.testPlugin.Windows.SaveBuilder.Clone_Block_To_Yml.clone_block;
...
public class Save_Success extends FormWindowSimple {
    ...
    public static FormWindowSimple SaveSuccess(Player p, String File, String Text) throws IOException {
        ...
        if (v != null && v.size() == 2) {
            ...
            simple.setContent("§4[Error] 未选择两点坐标! 请使用创世神选好坐标再保存！");
        }
